...
==============================
Odoo Medical Patient Ethnicity
==============================
...
`here <https://github.com/OCA/vertical-medical/issues/new?body=module:%20medical_patient_ethnicity0Aversion:%209.0.1.1.0%0A%0A**Steps%20to%20reproduce**%0A-%20...%0A%0A**Current%20behavior**%0A%0A**Expected%20behavior**>`_.
