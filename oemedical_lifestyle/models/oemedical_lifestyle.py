    ...
    _columns = {
        ...
        'dea_schedule_i': fields.boolean(
            ...
            help="Schedule I and II drugs have a high potential for abuse."
                 ...
                 " manufacturing, among other restrictions. Schedule I drugs"
                 " are available for research only and have no approved"
                 " medical use; Schedule II drugs are available only by"
                 " prescription (unrefillable) and require a form for"
                 " ordering. Schedule III and IV drugs are available by"
                 " prescription, may have five refills in 6 months, and may be"
                 " ordered orally. "
        ...
        'dea_schedule_ii': fields.boolean(
            ...
            help="Schedule I and II drugs have a high potential for abuse."
                 ...
                 " (unrefillable) and require a form for ordering. Schedule"
                 " III and IV drugs are available by prescription, may have"
                 " five refills in 6 months, and may be ordered orally."
                 " Some Schedule V drugs are available over the counter"),
...
class PatientCAGE(orm.Model):
    ...
    _columns = {
        ...
        'cage_e': fields.boolean(
            'Eye-opener',
            help='Have you ever felt you needed a drink first thing in the'
...
class MedicalPatient(orm.Model):
    ...
    _columns = {
        ...
        'recreational_drugs': fields.one2many(
            'oemedical.patient.recreational_drugs', 'patient_id', 'Drugs'),
        ...
        'car_child_safety': fields.boolean(
            'Car Child Safety',
            help="Safety measures when driving : child seats, proper seat"
                 " belting, not seating on the front seat, ..."),
        'home_safety': fields.boolean(
            'Home safety',
            help="Keep safety measures for kids in the kitchen, correct"
