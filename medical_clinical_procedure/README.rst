...
* `Procedure request <https://www.hl7.org/fhir/procedurerequest.html>`_
* `Procedure <https://www.hl7.org/fhir/procedure.html>`_

Usage
=====

#. Access `Medical /  Clinical / Procedure request` to manage procedure requests
#. Access `Medical /  Clinical / Procedure` to manage procedures
