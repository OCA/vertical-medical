...
class OeMedicalPatient(orm.Model):
    ...
    _columns = {
        'family': fields.many2one(
            'oemedical.family', string='Family', help='Family Code'),
        ...
        'evaluations': fields.one2many(
            'oemedical.patient.evaluation', 'patient_id',
            string='Evaluations',),
        ...
        'diseases': fields.one2many(
            'oemedical.patient.disease', 'patient_id',
            string='Diseases',
            help='Mark if the patient has died'),
        'ethnic_group': fields.many2one(
            'oemedical.ethnicity', string='Ethnic group',),
        'vaccinations': fields.one2many(
            'oemedical.vaccination', 'patient_id', 'Vaccinations',),
        'cod': fields.many2one(
            'oemedical.pathology', string='Cause of Death',),
    }
