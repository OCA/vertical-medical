    ...
    _columns = {
        ...
        'malnutrition': fields.boolean(
            ...
            help='Check this box if the patient show signs of malnutrition. If'
                 ...
                 'Moderate protein-energy malnutrition, E44.0 in ICD-10 '
                 'encoding'),
        'actions': fields.one2many(
            'oemedical.directions',
        ...
        'dehydration': fields.boolean(
            ...
            help='Check this box if the patient show signs of dehydration. If'
                 ' associated  to a disease, please encode the  correspondent '
                 'disease on the patient disease history. For example, Volume '
                 'Depletion, E86 in ICD-10 encoding'),
        'tag': fields.integer(
            string='Last TAGs',
        ...
        'reliable_info': fields.boolean(
            string='Reliable',
            help="Uncheck this option if the information provided by the "
                 "source seems not reliable"),
        ...
        'evaluation_endtime': fields.datetime(
        ...
        'chief_complaint': fields.char(
            string='Chief Complaint', size=256,
            required=True,
        ...
        'whr': fields.float(
            string='WHR', help='Waist to hip ratio'),
        'ldl': fields.integer(
            string='Last LDL',
