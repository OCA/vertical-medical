...
class OeMedicalMedicament(orm.Model):
    ...
    _columns = {
        'product_id': fields.many2one(
            'product.product', string='Medicament', requered=True,
            help='Product Name'),
        'name': fields.function(
            _get_name, type='char', string='Medicament', help="", multi=False),
        'category': fields.many2one(
            'oemedical.medicament.category', 'Category', select=True),
        'active_component': fields.char(
            string='Active component', size=256,
            help='Active Component'),
        'indications': fields.text(
            string='Indication', help='Indications'),
        'therapeutic_action': fields.char(
            string='Therapeutic effect', size=256,
