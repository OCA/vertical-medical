...
class MedicalPathology(orm.Model):
    ...
    _columns = {
        'category': fields.many2one('medical.pathology.category', string='Main Category',
        ...
        'groups': fields.one2many('medical.disease_group.members', 'disease_group_id', string='Groups',
