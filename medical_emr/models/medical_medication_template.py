...
class MedicalMedicationTemplate(orm.Model):
    ...
    _columns = {
        'medicament_id': fields.many2one(
            'medical.medicament', string='Medicament',
            requered=True, help='Product Name', ondelete='cascade'
        ),
        ...
        'frequency': fields.integer(
            ...
            help='Time in between doses the patient must wait (ie, for 1 pill'
                 ' each 8 hours, put here 8 and select \"hours\" '
                 'in the unit field'
        ),
        ...
        'admin_times': fields.char(
            size=256, string='Admin hours',
            help='Suggested administration hours.'
            'e.g: at 08:00, 13:00 and 18:00 can be encoded like 08 13 18'
        ),
