...
#        return res
        ...
        res = {
            'value': {
                'indication': medication_obj.browse(
                    cr, uid, medication, context=None
                ).indication.id,
                'form': medication_obj.browse(
                    cr, uid, medication, context=None
                ).form.id,
                'route': medication_obj.browse(
                    cr, uid, medication, context=None
                ).route.id,
                'dose': medication_obj.browse(
                    cr, uid, medication, context=None
                ).dose,
                'dose_unit': medication_obj.browse(
                    cr, uid, medication, context=None
                ).dose_unit.id,
                'qty': medication_obj.browse(
                    cr, uid, medication, context=None
                ).qty,
                'admin_times': medication_obj.browse(
                    cr, uid, medication, context=None
                ).admin_times,
                'common_dosage': medication_obj.browse(
                    cr, uid, medication, context=None
                ).common_dosage.id,
                'frequency': medication_obj.browse(
                    cr, uid, medication, context=None
                ).frequency,
                'frequency_unit': medication_obj.browse(
                    cr, uid, medication, context=None
                ).frequency_unit,
            }
        }
    ...
    _columns = {
        'name': fields.many2one(
            'medical.prescription.order', string='Prescription ID',
        ),
        'template': fields.many2one(
            'medical.medication.template', string='Medication',
        ),
        ...
        'active_component': fields.char(
            size=256, string='Active component', help='Active Component'
        ),
        ...
        'frequency_unit': fields.selection([
            (None, ''), ('seconds', 'seconds'), ('minutes', 'minutes'),
        ...
        'duration_period': fields.selection([
            (None, ''), ('minutes', 'minutes'), ('hours', 'hours'),
