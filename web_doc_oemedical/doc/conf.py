...
htmlhelp_basename = 'oemedical-doc'
...
man_pages = [
    ('index', 'oemedical-doc', u'OeMedical Documentation',
     [u'OeMedical'], 1)
]
...
texinfo_documents = [
    ('index', 'OeMedicalDocumentation',
     u'OpenERP Server Developers Documentation',
     u'OeMedical Team', 'OOeMedicalDocumentatio',
     'Developers documentation for the openobject-server project.',
     'Miscellaneous'),
]
