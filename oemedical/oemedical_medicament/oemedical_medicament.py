...
class OeMedicalMedicament(osv.osv):
    ...
    _columns = {
        'category': fields.many2one('oemedical.medicament.category', string='Category', ),
        'rec_name': fields.char(size=256, string='Name', required=True),
        'indications': fields.text(string='Indication'),
        'therapeutic_action': fields.char(size=256, string='Therapeutic effect', required=True),
        'name': fields.many2one('product.product', string='Product', ),
        #'pregnancy_category': fields.selection([], string='Pregnancy Category'),
        ...
        'active_component': fields.char(size=256, string='Active component', required=True),
