...
class OeMedicalPrescriptionOrder(osv.osv):
    ...
    _columns = {
        ...
        #'prescription_line': fields.one2many('oemedical.prescription.line', 'relation_id', string='Prescription line', ),
        ...
        'prescription_id': fields.char(size=256, string='Prescription ID', required=True),
    }
