...
class OeMedicalMedicationTemplate(osv.osv):
    ...
    _columns = {
        ...
        'route': fields.many2one('oemedical.drug.route', string='Administration Route', ),
        ...
        'indication': fields.many2one('oemedical.pathology', string='Indication', ),
        'medicament': fields.many2one('oemedical.medicament', string='Medicament', ),
        'common_dosage': fields.many2one('oemedical.medication.dosage', string='Frequency', ),
        'admin_times': fields.char(size=256, string='Admin hours', required=True),
        'end_treatment': fields.datetime(string='End'),
        'dose_unit': fields.many2one('oemedical.dose.unit', string='dose unit', ),
    }
